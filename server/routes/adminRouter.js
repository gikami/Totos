...
// router.get('/getaikocategory', adminController.getAikoCategory)
// router.get('/getaikoproducts', adminController.getAikoProducts)
// router.post('/sendaikoorder', adminController.sendAikoOrder)
