                ...
                return (
                    <div key={i} className="item p-3">
                        <div className="d-flex align-items-center">
                            <img
                                src={process.env.REACT_APP_API_URL + '/products/' + cart.image}
                                alt={cart.title}
                                className="me-3"
                            />
                        ...
                        <div className="d-flex align-items-center justify-content-end mt-2">
                            <div className="text-end sec-font fs-11 fw-5 ms-3">{total} ₽</div>
                        </div>
                        {cart.dop && cart.dop.length > 0 && (
                            <div className="flex-wrap product-dop d-flex mt-2">
                                {' '}
                                {cart.dop.map((dop) => (
                                    <div className="product-dop-box d-flex justify-content-between align-items-center">
                                        <div className="flex-1 fs-10">
                                            {dop.title} <span className="fw-5">{dop.price} ₽</span>
                                        </div>
                                        <div className="ms-2">
                                            <button
                                                type="button"
                                                className="btn-del"
                                                onClick={() => removeDop(cart, dop)}
                                            >
                                                <svg
                                                    width="33"
                                                    height="33"
                                    ...
                                    {cart.dop &&
                                        ...
                                        cart.dop.map((dop) => (
                                            <tr className="table-dop">
                                                ...
                                                <td className="pt-0">
                                                    <div className="primary fw-light">
                                                        <small>{dop.title}</small>
                                                    </div>
                                                </td>
                                                <td className="pt-0">
                                                    <div className="gray-1 fs-12 text-end fw-light">
                                                        <small>{dop.price} ₽</small>
                                                    </div>
                                                </td>
                                            </tr>
                                        ))}
        ...
        return (
            <div className="gx-xxl-5">
                <div className="d-flex justify-content-center justify-content-md-end">
                    <button type="button" className="gray-3 me-md-0 mb-4" onClick={removeAllProduct}>
                        Очистить корзину
                    </button>
                </div>
                {cart.cart.map((cart, i) => {
                            ...
                            <div className="d-flex w-100 align-items-center">
                                ...
                                <div className="text w-100 ms-3 ms-md-4 d-block d-md-flex justify-content-between align-items-center">
                                    ...
                                    <div className="btns d-flex align-items-center justify-content-between">
                                        ...
                                        <button
                                            type="button"
                                            className="btn-del d-none d-md-inline-block"
                                            onClick={() => removeProduct(cart)}
                                        >
                                            <svg viewBox="0 0 16 20" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1.14286 17.5556C1.14286 18.7429 2.17143 19.7143 3.42857 19.7143H12.5714C13.8286 19.7143 14.8571 18.7429 14.8571 17.5556V4.60317H1.14286V17.5556ZM16 1.36508H12L10.8571 0.285713H5.14286L4 1.36508H0V3.52381H16V1.36508Z" />
                ...
                <div className="d-block d-md-flex align-items-center justify-content-between">
                    ...
                    <div className="mb-4 mb-lg-0 d-none d-md-block">
                        ...
                        <div className="mt-3 d-block d-md-flex justify-content-end">
                            <Link to={CHECKOUT_ROUTE} className="btn btn-1">
                                Оформить заказ
                            </Link>
                        </div>
                    </div>
                    <div className="mb-4 mb-lg-0 d-block d-md-none">
                        <Link to={CHECKOUT_ROUTE} className="btn btn-1 py-3 fs-13 mt-3">
                            Оформить заказ за {cart.total ? cart.total : 0} ₽
                        </Link>
                        <Link to={CHECKOUT_ROUTE} className="btn btn-2 py-3 fs-13 mt-3">
                            Вернуться меню
                        </Link>
                    </div>
                </div>
