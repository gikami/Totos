                        ...
                        <div className="row m-0 justify-content-between align-items-center">
                            ...
                            <div className="col p-0">
                                <div className="add-to-cart">
                                    ...
                                    <button type="button" className="add-prod d-block d-md-none" onClick={() => (product.groupModifiers) ? history.push(PRODUCT_ROUTE + '/' + product.id) : (!updateState) ? addCart() : ''}>{(product.groupModifiers) ? 'от ' + product.price : product.price} ₽</button>
                                </div>
                            </div>
                        </div>
