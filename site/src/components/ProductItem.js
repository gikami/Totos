                ...
                <div className="row m-0 w-100">
                    <div className="col-5 col-sm-12 col-md-12 p-0">
                        <a onClick={() => history.push(PRODUCT_ROUTE + '/' + product.id)}>
                            <img
                                ...
                                src={
                                    product.image
                                        ? process.env.REACT_APP_API_URL + '/products/' + product.image
                                        : '/images/no-image.jpg'
                                }
                                effect="blur"
                            />
                    ...
                    <div className="col-7 col-sm-12 col-md-12 pl-2 pe-0 p-md-0">
                        ...
                        <div className="ingredients">
                            {product.mini_description ? product.mini_description : product.description}
                        </div>
                        <div className="row m-0 justify-content-between align-items-center">
                            <div className="col p-0 d-none d-md-block">
                                <div className="price mb-2 mb-md-0">
                                    <div className="sec-font d-flex flex-wrap flex-row-reverse flex-md-row align-items-center">
                                        <span className="fw-6 fs-15 align-middle">
                                            {product.groupModifiers ? 'от ' + product.price : product.price} ₽
                                        </span>
                                        {product.sale && product.sale > 0 ? (
                                            <span className="gray-3 text-decoration-line-through align-middle me-1 me-md-0 ms-1">
                                                {product.sale} ₽
                                            </span>
                                        ) : null}
                                    </div>
                            ...
                            <div className="col p-0">
                                <div className="add-to-cart">
                                    <button
                                        type="button"
                                        className="add-prod d-none d-md-block"
                                        onClick={() =>
                                    ...
                                    <button
                                        type="button"
                                        className="add-prod d-block d-md-none"
                                        onClick={() =>
                                            product.groupModifiers
                                                ? history.push(PRODUCT_ROUTE + '/' + product.id)
                                                : !updateState
                        ...
                        <button
                            ...
                            onClick={addFavorite}
                            data-state={btnFavoriteAdd ? 'on' : 'off'}
                        ></button>
                    </div>
                </div>
            </div>
