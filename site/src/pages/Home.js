            ...
            {productId && (
                <>
                    <MetaTags>
                        ...
                        <meta
                            property="og:image"
                            content={process.env.REACT_APP_API_URL + '/' + product.product.image}
                        />
                    </MetaTags>
                                ...
                                <div className="short-info row">
                                    ...
                                    <div className="col-md-7">
                                        <div className="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            {
                                                <div className="fs-14 fw-5 text-secondary">
                                                    {product.product.weight * 1000} г
                                                </div>
                                            }
                                        </div>
                                        <div className="text-secondary fs-14 mb-4">
                                            <span className="me-2">
                                                {product.product.mini_description
                                                    ? product.product.mini_description
                                        ...
                                        <div className="d-flex flex-row justify-content-between align-items-center">
                                            ...
                                            <div className="sec-font ms-2 mb-3 ms-sm-4">
                                                ...
                                                {product.product.sale > 0 && (
                                                    <div className="gray-3 text-decoration-line-through align-middle me-1 me-md-0 ms-1">
                                        ...
                                        <div className="d-flex flex-row align-items-center  mt-4">
                                            <div className="d-none d-md-flex justify-content-between align-items-center">
                                                <button
                                                    type="button"
                                                    onClick={addCart}
                                                    className="btn btn-1 fs-12 px-4 px-sm-5"
                                                >
                                                    {btnAdd.status ? 'Добавлено' : 'В корзину'}
                                                </button>
                                            </div>
                                            <div className="position-fixed d-md-none py-3">
                                                <button
                                                    type="button"
                                                    onClick={addCart}
                                                    className="btn btn-1 w-100 fs-12 px-4 px-sm-5"
                                                >
                                                    {btnAdd.status
                                                        ? 'Добавлено за ' + product.product.price + '₽'
                                                        : 'В корзину за ' + product.product.price + '₽'}
                                                </button>
                                            </div>
                                            {cart.getCartProductCount(product.product) ? (
                                                <div className="input-box ms-3">
                                                    <button
                                                        type="button"
                                                        onClick={() => minusCount(product.product)}
                                                    >
                                                    ...
                                                    <input
                                                        type="number"
                                                        placeholder="1"
                                                        value={cart.getCartProductCount(product.product)}
                                                        min={1}
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-md-7 col-lg-6 col-xl-5">
                                <h2 className="text-center">По техническим причинам сегодня 27.06.22 г. пиццерия Toto'S не работает.</h2>
                            </div>
                        </div>
                    </div>
                </section> */}
                <section id="sec-12">
                    ...
                    >
                        <SwiperSlide className="px-2">
                            <img src="/images/home-slide-1.jpg" alt="" className="img-fluid" />
                        </SwiperSlide>
                        <SwiperSlide className="px-2">
                            <img src="/images/home-slide-2.jpg" alt="" className="img-fluid" />
                        </SwiperSlide>
                        <SwiperSlide className="px-2">
                            <img src="/images/home-slide-3.jpg" alt="" className="img-fluid" />
                        </SwiperSlide>
                        <SwiperSlide className="px-2">
                            <img src="/images/home-slide-4.jpg" alt="" className="img-fluid" />
                        </SwiperSlide>
                    </Swiper>
                </section>
                <section className="sec-2 mb-8 mt-3 mt-md-5">
                    <div className="container">
                        {product.selectedCategory && product.selectedCategory.title ? (
                            <h1 className="h3 fw-6 mb-4 text-center text-md-start">
                                {product.selectedCategory.title}
                            </h1>
                        ) : (
                            ''
                        )}
