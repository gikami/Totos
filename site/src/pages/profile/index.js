                        ...
                        <div className="row">
                            ...
                            <div className="col-md-8 col-xl-7 col-xxl-6 offset-xl-1">
                                <form>
                                    ...
                                    <h5 className="gray-1">
                                        {user.user.firstname ? user.user.firstname : 'Имя'}{' '}
                                        {user.user.lastname ? user.user.lastname : 'Фамилия'}
                                    </h5>
                                    {user.user.phone ? (
                                        <fieldset className="mb-4 mb-sm-5">
                                            <legend className="gray-1 fw-5 fs-11 mb-3">Телефон</legend>
                                            <div className="d-sm-flex">{user.user.phone}</div>
                                        </fieldset>
                                    ) : null}
                                    {user.birthday ? (
                                        <fieldset className="mb-4 mb-sm-5">
                                            <legend className="gray-1 fw-5 fs-11 mb-3">День рождения</legend>
                                            <div className="d-sm-flex">{user.birthday}</div>
                                        </fieldset>
                                    ) : null}
                                    {user.user.sex ? (
                                        <fieldset className="mb-4 mb-sm-5">
                                            <legend className="gray-1 fw-5 fs-11 mb-3">Мой пол</legend>
                                            <div className="d-sm-flex">{user.user.sex ? 'Мужской' : 'Женский'}</div>
                                        </fieldset>
                                    ) : null}
                                </form>
                            </div>
