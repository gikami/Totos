                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 col-xl-7 col-xxl-6 offset-xl-1">
                            ...
                            {orders && orders.length > 0 ? (
                                                ...
                                                <div className="order">
                                                    <div>
                                                        ...
                                                        {JSON.parse(item.products).map((cart, i) => {
                                                            var param = cart.param
                                                                ? JSON.parse(cart.param)[0]
                                                                : false
                                                                ...
                                                                <>
                                                                        ...
                                                                        <td>
                                                                            <div className="pb-2">
                                                                                ...
                                                                                <span className="gray-3">
                                                                                    {cart.count ? cart.count : 1} шт
                                                                                </span>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div className="gray-1 text-end">
                                                                                {total} ₽
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    {cart.dop &&
                                                                        ...
                                                                        cart.dop.map((dop) => (
                                                                            <tr>
                                                                                <td>
                                                                                    <div className="pb-2 fw-light">
                                                                                        <small>
                                                                                            {dop.title}{' '}
                                                                                            <span className="gray-3 fw-light">
                                                                                                {dop.count
                                                                                                    ? dop.count
                                                                                                    : 1}
                                                                                                 шт
                                                                                ...
                                                                                <td>
                                                                                    <div className="gray-1 text-end fw-light">
                                                    ...
                                                    <div>
                                                        <div className="gray-1 fw-5">
                                                            {item.delivery == 1 ? 'Самовывоз' : 'Доставка'}
                                                        </div>
                                                        {item.delivery == 2 ? (
                                                            <div className="gray-2 mt-2">
                                                                {item.street +
                                                                    ' ' +
                                                                    item.home +
                                                                    (item.entrance
                                ...
                                <>
                                    <div className="gray-2 text-start mb-4">
                                        У вас пока не было ни одного заказа. Добавляйте <br /> товары и оформите свой
                                        первый заказ.
                                    </div>
                                    <Link to={HOME_ROUTE} className="btn btn-2 mb-5">
                                        В каталог
                                    </Link>
                                </>
                            )}
