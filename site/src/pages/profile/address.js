...
const Address = () => {
    ...
    const [address, setAddress] = useState(
        user.user.address && user.user.address.find((ids) => ids.id == actionId)
            ? user.user.address.find((ids) => ids.id == actionId)
            : {
                  name: '',
                  full: '',
                  street: '',
                            ...
                            <div className="col-md-8 col-xl-7 col-xxl-6 offset-xl-1">
                                <form onSubmit={submit} className="mb-4 mb-sm-5">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="mb-3">
                                            <span className="text-danger">*</span> - поля обязательные для заполнения
                                        </div>
                                    </div>
                            ...
                            <div className="col-md-8 col-xl-7 col-xxl-6 offset-xl-1">
                                <form action="" className="mb-4 mb-sm-5">
                                    ...
                                    {user.user.address && user.user.address.length > 0 ? (
                                                ...
                                                <div key={i} className="d-flex align-items-start mb-4">
                                                    ...
                                                    <div className="ms-2">
                                                        ...
                                                        <div className="d-flex mt-2">
                                                            <Link
                                                                to={PROFILE_ROUTE + '/address/edit/' + item.id}
                                                                className="fs-09 gray-1 me-3"
                                                            >
                                                                Редактировать
                                                            </Link>
                                                            <button
                                        ...
                                        <div className="fs-09 gray-1 mb-4">
                                            Добавьте адрес для доставки по умолчанию.
                                        </div>
                                    )}
                                    <Link
                                        to={PROFILE_ROUTE + '/address/add'}
                                        className="d-flex align-items-center fw-6"
                                    >
