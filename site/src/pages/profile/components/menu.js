    ...
    return (
        <div className="col-md-4 col-xl-3 mb-4">
            <nav>
                <ul>
                    <li>
                        <Link to={PROFILE_ROUTE + '/'} className={!id ? 'active' : null}>
                            Мой профиль
                        </Link>
                    </li>
                    <li>
                        <Link to={PROFILE_ROUTE + '/edit'} className={id === 'edit' ? 'active' : null}>
                            Настройки профиля
                        </Link>
                    </li>
                    <li>
                        <Link to={PROFILE_ROUTE + '/points'} className={id === 'points' ? 'active' : null}>
                            Бонусы
                        </Link>
                    </li>
                    <li>
                        <Link to={PROFILE_ROUTE + '/address'} className={id === 'address' ? 'active' : null}>
                            Адрес доставки
                        </Link>
                    </li>
                    {/* <li>
                    ...
                    <li>
                        <Link to={PROFILE_ROUTE + '/orders'} className={id === 'orders' ? 'active' : null}>
                            История заказов
                        </Link>
                    </li>
                    {/* <li>
                        ...
                        <div className="modal-body">
                            <div className="row justify-content-center">
                                <div className="col-md-8">
                                    ...
                                    <div className="text-center gray-3 mb-4">
                                        Не забудьте сохранить данные для входа
                                    </div>
                                    <div className="d-flex justify-content-center align-items-center">
                                        <button type="button" onClick={() => logOut()} className="btn btn-2 px-5">
                                            Да
                                        </button>
                                        <button type="button" data-bs-dismiss="modal" className="gray-2 ms-4">
                                            Остаться
                                        </button>
                                    </div>
                                </div>
