                ...
                (timeNow.getHours() === 22 || timeNow.getHours() < 10) ?
                    <section className="mb-8">
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-md-7 col-lg-6 col-xl-5">
                                    <h2 className="text-center">Мы работаем с 10:00 до 22:00</h2>
                                ...
                                <div className="row justify-content-between gx-4 gx-xl-5">
                                    <div className="col-md-7 col-xl-8 col-xxl-7">
                                        <div className="row mb-3">
                                            <label for="inputEmail3" className="col-sm-2 col-form-label">Имя:</label>
                                            <div className="col-sm-10">
                                                <input type="text" placeholder="Ваше имя" name="name" defaultValue={checkout.name} onChange={change} className="mb-3" />
                                            </div>
                                            <label for="inputEmail3" className="col-sm-2 col-form-label">Телефон:</label>
                                            <div className="col-sm-10">
                                                    ...
                                                    (user.isAuth && user.user.address && user.user.address.length > 0) ?
                                                        ...
                                                        <div className="row g-2 g-lg-3 sec-font">
                                                            ...
                                                            <div className="col-12">
                                                                ...
                                                                <div className="mt-2"><span className="text-danger">*</span> - поля обязательные для заполнения</div>
                                                            </div>
                                                            {
                                                                (user.isAuth) ?
                                                                    <div className="col-12">
