...
const Checkout = observer(() => {
    ...
    const updateTotal = () => {
        if (
            (cart.total < cart.deliveryMinPrice || cart.total < cart.deliveryMinDelivery) &&
            checkout.delivery == 2
        ) {
    ...
    const submit = async (e) => {
        ...
        if (data && data.data && data.data.Success && data.data.PaymentURL) {
            ...
            NotificationManager.error(
                data.message ? data.message : 'Произошла неизвестная ошибка, повторите попытку позже'
            )
        }
        setSendLoading(false)
    }
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-md-7 col-lg-6 col-xl-5">
                                ...
                                <div className="info-text text-center mb-4 mb-sm-5">
                                    Ожидайте звонка оператора от 2 до 15 минут. Мы свяжемся с вами для подтверждения
                                    заказа. Если вы не получили ответа,{' '}
                                    <bold>просим позвонить по телефону 226-80-06 (Гвардейская 33)</bold> или{' '}
                                    <bold>226-80-60 (Ямашева 97)</bold>
                                </div>
                                <Link to={HOME_ROUTE} className="btn btn-2 mx-auto py-md-3">
                                    В каталог
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-md-7 col-lg-6 col-xl-5">
                                ...
                                <p>
                                    Если в течении 5 секунд перенаправление не произошло, нажмите кнопку "Перейти к
                                    форме"
                                </p>
                                <a href={sendOrder.link} className="btn btn-2 mx-auto py-md-3">
                                    Перейти к форме
                                </a>
                            </div>
                        </div>
    ...
    return (
        <main>
            {timeNow.getHours() === 21 || timeNow.getHours() < 10 ? (
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-7 col-lg-6 col-xl-5">
                                ...
                                <div className="text-center mb-4 mb-sm-5">
                                    Вы можете пока собрать свой заказ в корзине и когда мы откроемся, оформить заказ.
                                </div>
                                <Link to={HOME_ROUTE} className="btn btn-2 mx-auto py-md-3">
                                    В каталог
                                </Link>
                ...
                //         <div className="row justify-content-center">
                //             <div className="col-md-7 col-lg-6 col-xl-5">
                //                 <h2 className="text-center">Ведутся технические работы</h2>
                //                 <div className="text-center mb-4 mb-sm-5">Вы можете оставить заказ по телефону 226-80-06 (Гвардейская 33) или 226-80-60 (Ямашева 97)</div>
                            ...
                            <div className="row justify-content-between gx-4 gx-xl-5">
                                <div className="col-md-7 col-xl-8 col-xxl-7">
                                    ...
                                    <fieldset className="mb-4 mb-sm-5">
                                        <legend className="title-font gray-1 fs-15 fw-7 mb-3">
                                        ...
                                        <div>
                                            <div className="switch fs-11 mb-4">
                                                <a
                                                    className={
                                                        checkout.delivery === 1
                                                            ? 'switch-option fw-6 active'
                                                            : 'switch-option fw-6'
                                                    }
                                                    onClick={() => setCheckout({...checkout, delivery: 1})}
                                                >
                                                    Самовывоз
                                                </a>
                                                <a
                                                    ...
                                                    onClick={() => setCheckout({...checkout, delivery: 2})}
                                                >
                                                    Доставка
                                                </a>
                                            </div>
                                            ...
                                            {checkout.delivery === 1 ? (
                                                <div className="row g-2 g-lg-3 sec-font pl-2 pr-2 pt-2">
                                                    <NavDropdown title={address} className="fw-6 fs-11 address-menu">
                                                        <NavDropdown.Item
                                                            onClick={addLocalAddress}
                                                            active={address == 'Ямашева 97' ? true : false}
                                                        >
                                                            Ямашева 97
                                                        </NavDropdown.Item>
                                                        <NavDropdown.Item
                                                            onClick={addLocalAddress}
                                                            active={address == 'Гвардейская 33' ? true : false}
                                                        >
                                                            Гвардейская 33
                                                        </NavDropdown.Item>
                                                    </NavDropdown>
                                                ...
                                                <>
                                                    <div className="fs-09 gray-1 mb-4">
                                                        Выберите адрес для доставки по умолчанию.
                                                    </div>
                                                    {user.user.address.map((item, i) => (
                                                        <div key={i} className="d-flex align-items-start mb-4">
                                                            ...
                                                            />
                                                            <div className="ms-2">
                                                                <label for={'address-' + i} className="gray-1 fw-5">
                                                    ...
                                                    <Link
                                                        to={PROFILE_ROUTE + '/address/add'}
                                                        className="d-flex align-items-center"
                                                    >
                                                        <img
                                                            src="/images/icons/plus3.svg"
                                                            alt="Добавить"
                                                            className="me-2"
                                                        />
                                                        ...
                                                        <div className="col-12">
                                                            <div className="d-flex align-items-center">
                                                                <input
                                                                    ...
                                                                    onChange={change}
                                                                />
                                                                <label for="save-address" className="ms-3">
                                                                    Сохранить адрес доставки в личном кабинете
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ) : null}
                                        ...
                                        <div className="sec-font">
                                            <div className="d-flex align-items-center mb-2">
                                                <input
                                                    ...
                                                    defaultChecked
                                                />
                                                <label for="sooner" className="flex-1 ms-2">
                                                    Как можно скорее
                                                </label>
                                            </div>
                                            <div className="d-flex align-items-center">
                                                <input
                                                    ...
                                                    id="in-time"
                                                />
                                                <label for="in-time" className="ms-2">
                                                    К назначенному времени{' '}
                                                </label>
                                                <input
                                                    type="date"
                                                    name="datevalue"
                                                    className="ms-2 w-fit py-2"
                                                    onChange={change}
                                                ...
                                                <div>
                                                    ...
                                                    <div className="d-flex align-items-center mb-3">
                                                        <input
                                                            ...
                                                            id="ecard"
                                                        />
                                                        <label for="ecard" className="ms-2">
                                                            Онлайн оплата
                                                        </label>
                                                    </div>
                                                </div>
                                ...
                                <div className="col-md-5 col-xl-4 position-relative">
                                    <div className="bonus">
                                        <div className="gray-1 title-font fw-7 fs-12 lh-15 text-center">
                                            При заказе от 700₽ - доставим бесплатно!
                                            <br />
                                            <Link className="text-success" to={DELIVERY_ROUTE}>
                                                ...
                                                <tbody>
                                                    <tr className="fs-12">
                                                        ...
                                                        <td className="fw-6 text-end">
                                                            {cart.total + (cart.sale.total ? cart.sale.total : 0)} ₽
                                                        </td>
                                                    </tr>
                                                    {cart.sale.total > 0 && (
                                                        <tr className="fs-12">
                                                            <td>
                                                                <small>
                                                                    {cart.sale.text ? cart.sale.text : 'Скидка: '}
                                                                </small>
                                                            </td>
                                                    ...
                                                    <tr className="fw-7">
                                                        ...
                                                        <td className="fs-16 text-end">
                                                            {checkout.total ? checkout.total : 0} ₽
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            {cart.deliveryMinPrice >
                                                ...
                                                checkout.delivery == 2 && (
                                                    <div className="text-danger text-center">
                                                        Минимальная сумма заказа {cart.deliveryMinPrice}₽
                                                    </div>
                                                )}
                                            {cart.deliveryMinDelivery >
                                                cart.total + (cart.sale.total ? cart.sale.total : 0) &&
                                                checkout.delivery == 2 && (
                                                    <div className="text-secondary text-center">
                                                        Добавьте товаров до {cart.deliveryMinDelivery}₽ и доставка
                                                        будет бесплатной
                                                    </div>
                                                )}
                                            <button
                                                ...
                                                type="submit"
                                                className="btn btn-1 mt-3 w-100 fs-11"
                                            >
                                                {sendLoading ? 'Отправка заявки...' : 'Оформить заказ'}
                                            </button>
                                        </div>
                                    </div>
                                    <div className="text-center fs-10 gray-3 mt-3">
                                        Нажимая "Оформить заказ", Вы соглашаетесь с{' '}
                                        <Link className="text-success" to={POLICY_ROUTE}>
