    ...
    if (favorite && favorite.favorite.length > 0) {
        return (
            <main>
                <div className="container mb-4 mb-md-5">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb mb-0">
                            ...
                            <li className="breadcrumb-item"><a>Избранные</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <section class="mb-8">
                    <div class="container">
                        <div class="d-sm-flex justify-content-between align-items-center mb-4 mb-md-5">
                            <h1 class="mb-sm-0">Избранное</h1>
                            <button type="button" class="sec-font primary fs-11 fw-5" onClick={removeAllFavorite}>Очистить список</button>
                        </div>

                        <div class="row row-cols-2 row-cols-sm-3 row-cols-xl-4 gx-2 gy-3 g-md-4">
                            {
