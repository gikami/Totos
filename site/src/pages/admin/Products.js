                ...
                <form onSubmit={submit}>
                    ...
                    <fieldset className="mb-2">
                        ...
                        <textarea
                            ...
                            value={product.mini_description}
                            className="mb-3"
                        />
                    </fieldset>
                    <fieldset className="mb-2">
        ...
        return (
            <div>
                <div className="d-flex justify-content-between mb-4">
                    <h5>{product.title}</h5>
                    <Link className="btn btn-1" to={ADMIN_ROUTE + '/products/add'}>
                        Добавить товар
                    </Link>
                </div>
                <form onSubmit={submit}>
                        ...
                        <select name="category" onChange={change}>
                            {categories && categories.length > 0 ? (
                                categories.map((item) => (
                                    <option
                                        value={item.id}
                                        selected={Number(product.category) === Number(item.id) && true}
                                    >
                                        {item.title}
                                    </option>
                                ))
                    ...
                    <fieldset className="mb-2">
                        ...
                        {product.image ? (
                            <img
                                className="mb-3"
                                width="200"
                                src={process.env.REACT_APP_API_URL + 'products/' + product.image}
                            />
                        ) : null}
                        ...
                        <tbody>
                            {products.rows.map((item) => (
                                <tr>
                                    ...
                                    <td align="right">
                                        <Link to={ADMIN_ROUTE + '/products/' + item.id}>Редактировать</Link>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
