                                ...
                                <div className="col-6 mb-4">
                                    <div className="card">
                                        <div className="card-header">
                                            <div className="d-flex justify-content-between align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        {loadingStreets ? 'Загрузка...' : 'Выгрузить'}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="card-body">
                                            {streets ? (
                                                <div>
                                                    Выгружено <b className="text-success">{streets.count}</b> улиц
                                                </div>
                                            ) : (
                                ...
                                <div className="col-6 mb-4">
                                    <div className="card">
                                        <div className="card-header">
                                            <div className="d-flex justify-content-between align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        {loadingCategories ? 'Загрузка...' : 'Выгрузить'}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="card-body">
                                            {categories ? (
                                                <div>
                                                    Выгружено <b className="text-success">{categories.count}</b>{' '}
                                                    категорий
                                                </div>
                                            ) : (
                                                <div className="no-result">
                                ...
                                <div className="col-6 mb-4">
                                    <div className="card">
                                        <div className="card-header">
                                            <div className="d-flex justify-content-between align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        {loadingProducts ? 'Загрузка...' : 'Выгрузить'}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="card-body">
                                            {products ? (
                                                <div>
                                                    Выгружено <b className="text-success">{products.count}</b>{' '}
                                                    товаров
                                                </div>
                                            ) : (
                                                <div className="no-result">
